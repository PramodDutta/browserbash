...
const jsonLd = {
    ...
    featureList: [
        ...
        'MCP server: Claude Code, Cursor and Codex consume BrowserBash as validation tools',
        'Deterministic Verify assertions with expected-vs-actual evidence (no model judgment)',
        'testmd v2 per-step execution with API steps for data seeding',
        'Saved login sessions (auth save / --auth) reused across runs and suites',
        'Monitor mode with Slack/webhook alerts on pass-fail changes',
        'Cost estimates per run and hard suite budgets (--budget-usd)',
        'Suite sharding across CI machines and viewport matrices',
        'Playwright suite import and click-through flow recorder',
