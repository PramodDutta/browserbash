...
// (www->apex is handled at the Vercel domain level, NOT here — an early
// redirect in the middleware can swallow Clerk's auth handshake.)
...
export default hasClerk
    ? clerkMiddleware(async (auth, req) => {
      ...
      }, { authorizedParties: ['https://browserbash.com', 'https://www.browserbash.com'] })
